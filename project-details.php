...
<body>
    <div class="page-wrapper <?= isIndia() ? 'light-mode' : '' ?>">
        ...
        <section class="banner-area pt-324 pb-250" style="background-image: url(assets/images/project-details/banner.png);">
        ...
        <section class="project-details py-128">
            <div class="container">
                <div class="content">
                    <div class="mb-64 align-items-center">
                        ...
                        <div class="row detail-info mb-64 wow fadeInLeft delay-0-1s">
                            ...
                            <div class="col-lg-6 text-right">
                                <p>It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem.</p>
                    ...
                    <div class="mb-64 align-items-center">
                        <div class="row detail-image mb-64 wow fadeInLeft delay-0-1s">
                            <img src="assets/images/project-details/detail-2.jpg" alt="Apartment">
                        </div>   
                    ...
                    <div class="mb-64 galley text-center wow fadeInLeft delay-0-1s">
                        <div class="row mb-30">
                            <div class="col-sm-8 col-lg-8 img">
                                <img src="assets/images/project-details/gal-1.jpg" alt="Apartment">
                            </div>
                            <div class="col-sm-4 col-lg-4 img">
                                <img src="assets/images/project-details/gal-2.png" alt="Apartment">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-4 col-lg-4 img">
                                <img src="assets/images/project-details/gal-3.jpg" alt="Apartment">
                            </div>
                            <div class="col-sm-4 col-lg-4 img">
                                <img src="assets/images/project-details/gal-4.png" alt="Apartment">
                            </div>
                            <div class="col-sm-4 col-lg-4 img">
                                <img src="assets/images/project-details/gal-5.jpg" alt="Apartment">
                            </div>
                        </div>
                    </div>
                    <div class="mb-64 align-items-center">  
