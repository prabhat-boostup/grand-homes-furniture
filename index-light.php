                        ...
                        <div class="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#home-tab-pane" role="tab" aria-selected="true">
                            <div class="about-content">
                                <div class="text">
                                    ...
                                    <p class="wow fadeInUp delay-0-2s">Indochine has worked on projects nationwide and worldwide, designs that make magic happen, without the wand. focuses more on structural design, whereas interior design is the practice of creating interior atmosphere.</p>
                                    <p class="wow fadeInUp delay-0-3s">Indochine has worked on projects nationwide and worldwide, designs that make magic happen, without the wand. focuses more on structural design, whereas interior design is the practice of creating interior atmosphere.</p>
                                </div>
                                <div>
                                    <img class="big-image wow zoomIn" src="assets/images/about/1.png" alt="hero image" title="hero image">
                        ...
                        <div class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile-tab-pane" role="tab" aria-selected="false">
                            <div class="about-content">
                                <div class="text">
                                    ...
                                    <p class="fadeInUp delay-0-2s animated">Indochine has worked on projects nationwide and worldwide, designs that make magic happen, without the wand. focuses more on structural design, whereas interior design is the practice of creating interior atmosphere.</p>
                                    <p class="fadeInUp delay-0-2s animated">Indochine has worked on projects nationwide and worldwide, designs that make magic happen, without the wand. focuses more on structural design, whereas interior design is the practice of creating interior atmosphere.</p>
                                </div>
                                <div>
                    ...
                    <div class="carousel-inner" role="listbox">
                        <div class="carousel-item active">         
                            <div class="col-lg-6 service-act">
                                ...
                                <div class="carousel-caption">
                                    <div class="big-text mb-16">ART</div>
                        ...
                        <div class=" carousel-item">
                            <div class="col-lg-6 service-act">
                                ...
                                <div class="carousel-caption">
                                    <div class="big-text mb-16">DECOR</div>
                                    <p class="mb-32">We have several strategic teaming arrangements <br> with experienced to complete full design services.</p>
                                    <a href="project-details.php"><span class="right-arrow"><i class="fa fa-long-arrow-right"></i></span></a>
                                </div>                                
                            </div>
